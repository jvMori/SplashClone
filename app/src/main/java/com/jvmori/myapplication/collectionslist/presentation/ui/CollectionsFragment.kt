...
import com.jvmori.myapplication.collectionslist.data.localToEntity
...
class CollectionsFragment : CategoryPageFragment(), IOnClickListener {
    ...
    private fun fetchCollections() {
        viewmodel.collections.observe(this@CollectionsFragment, Observer {
            it.map { collectionData ->
                collectionData.localToEntity()
            }.let {
